          ...
          <header class="mainHeader text-white">
            <div class="container">
              <div class="row justify-content-between align-items-center">
                <div class="col-md-6">
                  <h1 class="animate__animated animate__slideInDown animate__slow	1s">Webcon radionice - kodirajte sa nama</h1>
                ...
                <div class="col-md-6">
                  <img src="img/header-img.png" class="img-fluid">
                </div>
              </div>
            </div>
          </header>
          ...
          <section class="kalendar container text-dark">
            ...
            <div class="col-md-4 position-relative mb-3">
              <a href="radionica1.php">
                <div class="featuredImage shadow-lg">
                <img src="img/kodiranje_uzivo_sredom.png" alt="" class="img-fluid">
              </div>
              </a>
              <h3 class="pt-3">Kodiranje uživo sredom</h3>
            ...
            <a href="radionica2.php">
              <div class="col-md-4 position-relative mb-3">
                <div class="featuredImage shadow-lg">
                  <img src="img/izazov.png" alt="" class="img-fluid">
                </div>
            </a>
            ...
            <a href="radionica3.php">
              <div class="col-md-4 position-relative mb-3">
                <div class="featuredImage shadow-lg">
                  <img src="img/prakticni veb dizajn.jpg" alt="" class="img-fluid">
                </div>
            </a>
            ...
            <a href="radionica3.php">
              <div class="col-md-4 position-relative mb-3">
                <div class="featuredImage shadow-lg">
                  <img src="img/javascript.jpg" alt="" class="img-fluid">
                </div>
            </a>
